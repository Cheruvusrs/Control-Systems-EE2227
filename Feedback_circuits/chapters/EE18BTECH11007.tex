...
\begin{figure}[!ht]
	\begin{center}
		...
		\resizebox{\columnwidth}{!}{\input{circuit1}}
	\end{center}
\caption{circuit1}
\label{fig:circuit1}
\end{figure}
...
\begin{figure}[!ht]
	\begin{center}
		...
		\resizebox{\columnwidth}{!}{\input{circuit2}}
	\end{center}
\caption{circuit2}
\label{fig:circuit2}
\end{figure}
...
\solution employing loading rules in fig.\ref{fig:circuit1},we obtain circuit3 given in fig.\ref{fig:circuit3}
 \begin{figure}[!ht]
	\begin{center}
		...
		\resizebox{\columnwidth}{!}{\input{circuit3}}
	\end{center}
\caption{circuit3}
\label{fig:circuit3}
\end{figure}
\begin{figure}[!ht]
	\begin{center}
		...
		\resizebox{\columnwidth}{!}{\input{circuit4}}
	\end{center}
\caption{circuit4}
\label{fig:circuit4}
\end{figure}
...
\begin{figure}[!ht]
	\begin{center}
		...
		\resizebox{\columnwidth}{!}{\input{block_diagram}}
	\end{center}
